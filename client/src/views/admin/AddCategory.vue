        ...
        >
          <div class="w-full max-w-[600px] m-5 p-5 shadow-lg">
            <div class="w-full text-center">
              <h1 class="font-bold text-2xl m-3 p-5">Kategoriya Əlavə Et</h1>
            </div>
            <div class="w-full">
              <div>
              ...
              <div>
                <label class="inline-flex items-center mt-3">
                  ...
                  /><span class="ml-2 text-text">Mebel</span>
                </label>
              </div>
              <div>
                <label class="inline-flex items-center mt-3">
                  <input
                    type="checkbox"
                    class="form-checkbox h-5 w-5 text-gray-600"
                  /><span class="ml-2 text-gray-700">Dəmir İşçiliyi</span>
                </label>
              </div>
              <div>
                <label for="HCategory" class="text-xl font-bold">
                  Kategoriyanın Adını Yazın:
                </label>
              </div>
              <div>
                <input
      ...
      >
        ...
        <div class="text-center py-8 sm:py-6">
          ...
          <div>
            <button
              type="submit"
              class="p-2 m-2 w-[70px] h-[5vh] bg-danger text-second flex flex-center font-bold rounded-md"
            >
              Sil
            </button>
          </div>
